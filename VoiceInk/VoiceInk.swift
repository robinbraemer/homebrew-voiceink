...
class UpdaterViewModel: ObservableObject {
    ...
    init() {
        #if LOCAL_BUILD
        if UserDefaults.standard.object(forKey: Self.autoUpdateCheckKey) == nil {
            UserDefaults.standard.set(true, forKey: Self.autoUpdateCheckKey)
        }
        automaticallyChecksForUpdates = UserDefaults.standard.bool(forKey: Self.autoUpdateCheckKey)
    ...
    func setAutomaticallyChecksForUpdates(_ value: Bool) {
        ...
        UserDefaults.standard.set(value, forKey: Self.autoUpdateCheckKey)
        if value {
            checkAppcastForUpdates()
        }
        #else
